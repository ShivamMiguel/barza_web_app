...
export default function ProfilePage() {
  ...
  return (
    <div className="bg-surface-container-lowest text-on-surface font-body selection:bg-primary-container selection:text-on-primary min-h-screen flex">
          ...
          {activeTab === "vault" && (
            <section className="glass-panel rounded-3xl p-12">
              ...
              <p className="text-on-surface-variant max-w-2xl mb-12">
                Curated selections personally tested and recommended. Exclusive access to premium beauty staples.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  {
                    name: "Obsidian Essence Oil",
                    price: "$124",
                    brand: "Midnight Skincare",
                  },
                  {
                  ...
                  <div
                    key={idx}
                    className="bg-surface-container-lowest/50 rounded-2xl p-6 group hover:-translate-y-1 transition-all border border-transparent hover:border-primary-container/20"
                  >
      ...
      <aside className="w-80 h-screen fixed right-0 top-0 bg-[#0e0e0e] border-l border-white/5 p-6">
        {/* Search & Tabs */}
        <div className="mb-10">
