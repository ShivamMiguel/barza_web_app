        ...
        <div className="mt-auto px-4 flex flex-col gap-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-on-surface group-hover:text-[#ff9156] transition-colors truncate">Beatriz Luanda</p>
              <p className="text-[10px] text-on-surface-variant/50 font-label uppercase tracking-widest">Ambassador</p>
            </div>
            <span className="material-symbols-outlined text-on-surface-variant/30 text-sm group-hover:text-[#ff9156]/60 transition-colors">chevron_right</span>
          </Link>
        </div>
      </aside>

      {/* Main Content */}
      <main className="ml-64 mr-80 min-h-screen bg-surface-container-lowest p-8 relative">
        {/* Header */}
        <header className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-[3.5rem] font-headline font-extrabold tracking-tighter leading-none mb-2">Discover</h2>
            <div className="h-1 w-12 volcanic-gradient rounded-full"></div>
          </div>
          <div className="flex items-center gap-4">
            <button className="p-3 bg-surface-container rounded-full text-on-surface-variant hover:bg-surface-container-high transition-colors">
        ...
        <div className="space-y-12 max-w-3xl mx-auto">
          ...
          <article className="bg-surface-container rounded-3xl overflow-hidden shadow-[0_40px_60px_-15px_rgba(255,255,255,0.04)] border-t border-primary/20">
            <div className="p-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCvWbJrwkh9rm1AWaAizoot_oRmZYIa-a5hk9hQvSQKBKAm_-xtbrzVtPeIldN6AauiYqtxq98NKcvmGD6CJIQKRKxJL9CAdSvInm6YvLwHlKmMN0nPVzmFvVTj4VPMQZ1BtO2US2sdVW4cpfaAL4HHHQFWlpt_OP43ZHsNWOMlYUSfVbkagkc9YXrdE5D1jMrjTUCUcIXHnk2kDSBWaamwobb7f6Jf45EsV1M_L9CSYFliLbGPV5JpniwyQ6jnkD-YHd9SKfoliuQ" alt="Carlos Fade Studio" className="w-12 h-12 rounded-full object-cover" />
                <div>
            ...
            <div className="relative aspect-square w-full bg-surface-container-highest overflow-hidden">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCa5P37XvWjwJAJA0V0T62PA1pea9eXalF7n38KxH8ZIA5hkkdtrTLYXVKKbrc3oytmrHyH-yY2j43sTUa4jcmlzluraW8SUtxm665tpm90OR9Fp0bmDIKZlV7l5AIn7f0W9Wu0NiVnkJuphTgxK4KwovVxgq9m2GrVHEU1yxFWheaEhsBiGDaKk9J9uPuncViKVogffveiWiJOExKhqVNnz7l08IIyrP4akh3NMkpFvhaMsmEarc6km-fe53zzcWqlm2wxzbk24DA" alt="Professional haircut" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                <div className="flex gap-4 w-full">
                  <button className="flex-1 volcanic-gradient text-on-primary py-3 rounded-xl font-bold active:scale-95 transition-all">Agendar Agora</button>
                  <button className="flex-1 bg-surface-variant/80 backdrop-blur-md text-on-surface py-3 rounded-xl font-bold border-t border-white/10 active:scale-95 transition-all">Ver Perfil</button>
                </div>
              </div>
          ...
          <article className="bg-surface-container-low rounded-3xl p-6 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)]">
            <div className="flex items-center gap-3 mb-6">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrzgf9C9xCklkfrHiJJzRPpW2DfurCxtBh2QpSzxHXLAs0j7bn5QSGcsjwEwXgqfrqU-6GSL79cAN_Rh78pLV91KoBb4PNdNKZtw1dDZwXK0wXIJg7NTzLTe7514sZ5hu5aXv6hfmLX0OJQojMHjPt8g8KIVcZj3q7rLPH8a_naoSOZjLYPDV5vGs075Axy1Y_Bf0tUXTYN6rQ-GsO9npNywPyKqbZKZoFEBQe4dHl2fgRsDz1ub-eWjk9g4wj2xdCy0vTDm-T1sY" alt="Elena Kizua" className="w-10 h-10 rounded-full object-cover" />
              <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuDVf9uiVkQwBaz1VCekWU_W5OLk5TKquGgN729VJ7Mh3sl9YlloVmdR-KB7BCLYN7oO45mvK0iXfdv8JDYjwl_-jYMNntINqLLeVTwnWFm_lcaZ9YMH4LrmB5OQv7-bp3t1GE3MxhrNfW1XRmJDZkljZ3hvA9ZndcSD1rb4k-4dVYgxcy6eGrRGcZ-SussPzV84Tnfq5M2J2AxDGFArKCeoDbY8ureMo2DEL8vqJWF_1Eh3w4U_lnPZbDWrUWW97-Z7ge_nOKRL7oA" alt="Elena new hairstyle" className="w-full aspect-[4/5] object-cover rounded-2xl" />
              <div className="flex flex-col justify-between">
                <p className="text-sm italic font-light leading-relaxed">"Quando cuidas da imagem, a alma agradece. O melhor toque de Luanda! ✨"</p>
          ...
          <article className="relative h-[400px] rounded-3xl overflow-hidden group cursor-pointer border border-primary/10">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBiAxnKPk4Jxz6fwJXcYdS6Tr6NtVz66SuXfie4I6eD1WYUkTbg2Nb4p0R66gfLSqkFUkaCvTB8aupO5KgLvJujSSu3eOTInaTt0HpHHC7TIAE5KOn8NzENFufFUqMbevQRwXP6pJLjjw2TtGe1KOaHAvWK5Stux9BiSFQZLgHABzbVVbmDN2RNCLA3_68l9vO0u0fJaVoibD1V3ejrQ4MW2N4EYXWN0MvPgsPune-1wuZGqn3e5yreQS2DvT8bw-sJs32b9eZjl_4" alt="Luanda skyline" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0e0e0e] via-[#0e0e0e]/40 to-transparent p-10 flex flex-col justify-end">
              <span className="bg-primary-container/20 backdrop-blur-md text-primary-container text-[10px] font-label uppercase tracking-[0.2em] px-3 py-1 rounded-full w-fit mb-4">Trending Article</span>
              <h2 className="text-3xl font-headline font-bold tracking-tight mb-6 max-w-md leading-tight">5 tendências masculinas que estão a crescer em Luanda</h2>
          ...
          <article className="bg-surface-container rounded-3xl p-2 flex border-t border-primary/5">
            <div className="w-1/3 aspect-square rounded-2xl overflow-hidden relative">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAO67T6DeLRMvQWSXz2p7SD1J8JMFAgTfUM8WCPctIAHUAz0kKnV8aomUdOXPrL9rvQzUQlm55kcQmyts4PAyaX4OTQOJ_bj-GLzpodeOk_8aI1FeyjpzkL2rg4iz1XFooC4zPqVVceTy1JpngDFa5xJy0SvRfLnv33QJoetatcBHUG77kM4usuI6UdOE8-JENVgCEupOkpFcWiMbhfK911jTvwINh5mXBgcd0PXUtiSo5Ve6NHLNn1p2j3NyzQ_A-ry5Pm2ssTQGY" alt="Beard Oil" className="w-full h-full object-cover" />
              <span className="absolute top-3 left-3 bg-primary-container text-on-primary text-[10px] font-label uppercase font-black px-2 py-1 rounded-sm">Best Seller</span>
            </div>
            <div className="flex-1 p-6 flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs text-on-surface-variant mt-2 line-clamp-2">Premium hydration for the modern gentleman. Infused with Angolan Marula oil.</p>
              </div>
              <div className="flex items-center justify-between mt-4">
                <span className="text-xl font-headline font-black text-primary-container">12.500 Kz</span>
                <button className="bg-surface-variant px-6 py-2 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-primary-container transition-colors hover:text-on-primary">Comprar</button>
              </div>
            </div>
          </article>
          ...
          <article className="glass-panel rounded-3xl p-8 border-l-4 border-primary-container">
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 bg-primary-container/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-primary-container text-3xl" style={{fontVariationSettings: "'FILL' 1"}}>psychology</span>
              </div>
              <div className="flex-1">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed mb-6">Exploramos como as ferramentas de Realidade Aumentada estão a transformar a experiência de consumo em Luanda e Joanesburgo.</p>
      ...
      <aside className="w-80 h-screen fixed right-0 top-0 bg-[#0e0e0e] border-l border-white/5 p-6 obsidian-scroll overflow-y-auto">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              { name: 'Marco Estilo', role: 'Men\'s Grooming Specialist', trend: '+4.2%', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC9HfCoTnb8KFEjf3Kf9AY1utalCitwvKuP4GSIAG0rMtzQ6ob1d_chlMDuPM23jwLfaO4iT3hP-UV5pVaHlTdWjd17vwk_AW71T6siQOYvYY3cB93zkrSTARC58qvmPM-l2HqKXP4qrQ-s8vAmsRhjpKLv8K7TQMxrFp7eR7s7ggD0ngIXSIspHB4S2qPq0F2wptO3LRoU-bQMXnI36M_3BgZ4R7aRUUHMnu7gtGHs8cRqRELfJLEQx7SSgU_cDMPD3k-36l5EJ3A' },
              { name: 'Ana Nails VIP', role: 'High-End Nail Artistry', trend: '+3.8%', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB52nVhRZzNl4e-qSuk_B7ApmrDEbxPfmW1yvGwh3iWS8ODd9LOE1FnUgLO4ltSw85Df70UY5Won2oG4Z3ducQlCxoVjbaZtFgGsJtFoNY59CgZ4wZFzYTuxVTy5VnqqkqUIDamkOW92jrUolCR5wb0_CphL-9mSAL19WGtJ_chnAM-JYfpYN0EWnYCN3pF1vhanMkMkKsQ03yHJ7jhC-VcMH51_4zAt-ScwC1PSEms7-OZECbxIhiV-Yhc-lv9WRWe_-ojnChaXrY' },
            ].map((pro, idx) => (
