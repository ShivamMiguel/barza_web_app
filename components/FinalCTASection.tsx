    ...
    <section className="py-32 px-8 bg-primary-container relative">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          <button className="bg-on-primary text-white font-bold px-12 py-6 rounded-2xl text-xl flex items-center gap-4 hover:brightness-125 transition-all w-full md:w-auto shadow-2xl">
