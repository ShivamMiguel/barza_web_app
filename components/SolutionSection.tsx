      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-surface-variant/40 backdrop-blur-xl p-8 rounded-2xl refractive-edge shadow-xl flex flex-col h-full md:mt-12">
            ...
            <h3 className="text-xl font-bold mb-4 uppercase tracking-tighter font-headline">Serviços</h3>
            <p className="text-on-surface-variant mb-8 flex-grow">Marcação inteligente em segundos. Filtra por localização, especialidade e avaliações reais da comunidade.</p>
            <a className="text-primary-container font-bold flex items-center gap-2 group" href="#">Marcar Agora <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span></a>
          </div>
          <div className="bg-surface-variant/40 backdrop-blur-xl p-8 rounded-2xl refractive-edge shadow-xl flex flex-col h-full">
            <div className="aspect-video mb-8 rounded-lg overflow-hidden border border-white/5">
            ...
            <h3 className="text-xl font-bold mb-4 uppercase tracking-tighter font-headline">Produtos</h3>
            <p className="text-on-surface-variant mb-8 flex-grow">Curadoria de produtos profissionais. Do cuidado capilar à estética, o que os melhores usam está aqui.</p>
            <a className="text-primary-container font-bold flex items-center gap-2 group" href="#">Loja Pro <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span></a>
          </div>
        </div>
      </div>
    </section>
